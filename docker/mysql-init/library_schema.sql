...
CREATE TABLE loans (
   ...
   borrowedAt  TIMESTAMP(6) NOT NULL,
   returnedAt  TIMESTAMP(6) NULL,
   PRIMARY KEY (id),
...
INSERT INTO users (id, username, firstname, lastname, email) VALUES
     (1, 'demo_user_1', 'Demo', 'Eins',  'demo1@example.test'),
...
-- books
INSERT INTO books (id, isbn, title, author, publishedAt, publisher, language, description, pages) VALUES
  (1001, '9780132350884', 'Clean Code',                   'Robert C. Martin',               2008, 'Prentice Hall',   'EN', 'Beschreibung Clean Code', 464),
...
INSERT INTO loans (id, user_id, book_id, borrowedAt, returnedAt) VALUES
 (1, 1, 1001, DATE_SUB(NOW(6), INTERVAL 5 DAY), NULL),   -- aktiv: demo_user_1 -> Clean Code
